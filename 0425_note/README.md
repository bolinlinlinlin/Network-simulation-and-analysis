...
### ssh tunnel
### ex1. 透過 ssh tunnel 連接到外部
- 資料：[ssh tunnel](http://csie.nqu.edu.tw/smallko/sdn/sshtunnel.htm)

![20220425-2](/img/20220425-2.jpg)
- lab2.py
```py
#!/usr/bin/python
